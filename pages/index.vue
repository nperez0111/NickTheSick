  ...
  <v-layout column justify-center align-center>
    <Full-Height class="blue fullwidth" src="/trianglify.svg">
      <v-layout column justify-center align-center class="my-4">
        <h1 :class="{'text-xs-center':true, 'display-3':$vuetify.breakpoint.lgAndUp, 'display-4':$vuetify.breakpoint.xlAndUp,'display-2':$vuetify.breakpoint.mdAndDown, 'my-1':true}">I'm <span class="black--text">Nicholas Perez</span>.</h1>
